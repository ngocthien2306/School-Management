...
namespace School_Management.Manager.Student.Views.CourseCollectionView{
    public partial class CourseCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<School_Management.Manager.Student.ViewModels.CourseCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as School_Management.Manager.Student.Course,
