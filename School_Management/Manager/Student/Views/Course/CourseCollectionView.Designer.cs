namespace School_Management.Manager.Student.Views.CourseCollectionView {
    partial class CourseCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Course Tasks";
			...
			this.courseCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.courseCollectionViewBindingSource.DataSource = typeof(School_Management.Manager.Student.Course);
			this.gridControl.DataSource = courseCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(School_Management.Manager.Student.Course),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(School_Management.Manager.Student.ViewModels.CourseCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.CourseCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.CourseCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.CourseCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.CourseCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "CourseCollectionView";
		...
		private System.Windows.Forms.BindingSource courseCollectionViewBindingSource;
