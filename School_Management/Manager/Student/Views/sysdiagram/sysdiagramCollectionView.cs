...
namespace School_Management.Manager.Student.Views.sysdiagramCollectionView{
    public partial class sysdiagramCollectionView : XtraUserControl {
        public sysdiagramCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<School_Management.Manager.Student.ViewModels.sysdiagramCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as School_Management.Manager.Student.sysdiagram,
