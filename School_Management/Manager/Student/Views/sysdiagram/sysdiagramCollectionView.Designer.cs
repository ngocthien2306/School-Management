namespace School_Management.Manager.Student.Views.sysdiagramCollectionView {
    partial class sysdiagramCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "sysdiagram Tasks";
			...
			this.sysdiagramCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.sysdiagramCollectionViewBindingSource.DataSource = typeof(School_Management.Manager.Student.sysdiagram);
			this.gridControl.DataSource = sysdiagramCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(School_Management.Manager.Student.sysdiagram),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(School_Management.Manager.Student.ViewModels.sysdiagramCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.sysdiagramCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.sysdiagramCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.sysdiagramCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.sysdiagramCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "sysdiagramCollectionView";
		...
		private System.Windows.Forms.BindingSource sysdiagramCollectionViewBindingSource;
