...
namespace School_Management.Manager.Student.Views.Add_StudentCollectionView{
    public partial class Add_StudentCollectionView : XtraUserControl {
        public Add_StudentCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<School_Management.Manager.Student.ViewModels.Add_StudentCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as School_Management.Manager.Student.Add_Student,
