namespace School_Management.Manager.Student.Views.Add_StudentCollectionView {
    partial class Add_StudentCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Add_Student Tasks";
			...
			this.add_StudentCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.add_StudentCollectionViewBindingSource.DataSource = typeof(School_Management.Manager.Student.Add_Student);
			this.gridControl.DataSource = add_StudentCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(School_Management.Manager.Student.Add_Student),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(School_Management.Manager.Student.ViewModels.Add_StudentCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.Add_StudentCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.Add_StudentCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.Add_StudentCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.Add_StudentCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "Add_StudentCollectionView";
		...
		private System.Windows.Forms.BindingSource add_StudentCollectionViewBindingSource;
