...
namespace School_Management.Manager.Student.Views.LoginCollectionView{
    public partial class LoginCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<School_Management.Manager.Student.ViewModels.LoginCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as School_Management.Manager.Student.Login,
