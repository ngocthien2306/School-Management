namespace School_Management.Manager.Student.Views.LoginCollectionView {
    partial class LoginCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Login Tasks";
			...
			this.loginCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.loginCollectionViewBindingSource.DataSource = typeof(School_Management.Manager.Student.Login);
			this.gridControl.DataSource = loginCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(School_Management.Manager.Student.Login),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(School_Management.Manager.Student.ViewModels.LoginCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.LoginCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.LoginCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.LoginCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.LoginCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource loginCollectionViewBindingSource;
