namespace School_Management.Manager.Student.Views.NameView {
    partial class NameView {
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "Name Tasks";
			// 
			...
			this.nameViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.nameViewBindingSource.DataSource = typeof(School_Management.Manager.Student.Name);
			this.dataLayoutControl1.DataSource = nameViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(School_Management.Manager.Student.ViewModels.NameViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameViewModel), "ResetLayout", bbiResetLayout));
		...
		private System.Windows.Forms.BindingSource nameViewBindingSource;
