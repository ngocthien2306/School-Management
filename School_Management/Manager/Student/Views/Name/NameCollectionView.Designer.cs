namespace School_Management.Manager.Student.Views.NameCollectionView {
    partial class NameCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Name Tasks";
			...
			this.nameCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.nameCollectionViewBindingSource.DataSource = typeof(School_Management.Manager.Student.Name);
			this.gridControl.DataSource = nameCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(School_Management.Manager.Student.Name),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(School_Management.Manager.Student.ViewModels.NameCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(School_Management.Manager.Student.ViewModels.NameCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource nameCollectionViewBindingSource;
